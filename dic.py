...
dic = {
    ...
    "mark_as_viewed": {
        "E": "Mark as Viewed",
        "U": "Позначити як переглянутий",
        "R": "Пометить как просмотренный"
    },
    ...
    "let_us_know": {
        "E": "If you have a web site or page, let us know, we will know more about you",
        "U": "Якщо у вас є веб-сайт або сторінка, дайте нам знати, ми дізнаємось більше про Вас",
        "R": "Если у вас есть веб-сайт или страница, дайте нам знать, мы узнаем больше о Вас"
    },
