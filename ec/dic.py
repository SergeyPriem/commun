...
dic = {
    ...
    "how_it_works_1": {
        "E": "To become a full-fledged member of the Community, you need **to register**.\n\n"
             ...
             "platform._",
        "U": "Щоб стати повноправним учасником Спілки, необхідно **зареєструватися**. Зареєстровані Замовники можуть "
             "додавати необмежену кількість Проектів, мають доступ до Анкет усіх Інженерів та можуть запрошувати їх "
             "до участі в своїх Проектах.\n\n"
        ...
        "R": "Чтобы стать полноправным участником Сообщества, необходимо зарегистрироваться. Зарегистрированные "
             "Заказчики могут добавлять неограниченное количество Проектов, имеют доступ к Анкетам всех Инженеров и "
             "могут приглашать их к участию в своих Проектах.\n\n"
